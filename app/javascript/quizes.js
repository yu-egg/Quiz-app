  window.addEventListener("DOMContentLoaded", () =>{
    ...
    
    {
      ...
      const quizSet = shuffle([
        ...
        {q: 'テキスト形式とは?', c: ['文字コードと、改行やタブなど一部の制御文字のみで作られるファイル形式です。', '個々のデータである文字や数字をカンマ（,）で区切り、行と行を改行で区切ることで、表形式のデータを保存することに特化したファイル形式です。']},
        {q: 'CSV形式とは?', c: ['個々のデータである文字や数字をカンマ（,）で区切り、行と行を改行で区切ることで、表形式のデータを保存することに特化したファイル形式です。', '画像が埋め込まれた書類を、コンピュータの機種やOSの種類に依らず、元の通りに再現して表示することができる電子文書のファイル形式です。']},
        {q: 'PDFとは?', c: ['画像が埋め込まれた書類を、コンピュータの機種やOSの種類に依らず、元の通りに再現して表示することができる電子文書のファイル形式です。', '文字コードと、改行やタブなど一部の制御文字のみで作られるファイル形式です。']},
        {q: '画像用のファイル形式とは?', c: ['BMP JPEG GIF,PNG', 'MP３,MIDI']},
        {q: '音声用のファイル形式とは?', c: ['MP３,MIDI', 'MPEG']},
        {q: '動画用のファイル形式とは?', c: ['MPEG', 'BMP JPEG GIF,PNG']},
      ]);
      let currentNum = 0;
      let isAnswered;
      let score = 0;
